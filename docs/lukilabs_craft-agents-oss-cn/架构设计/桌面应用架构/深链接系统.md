...
- 测试用例：apps/electron/src/main/__tests__/deep-link-routing.test.ts
...
- [apps/electron/src/shared/types.ts](file://apps/electron/src/shared/types.ts#L199-L203)
- [apps/electron/src/main/__tests__/deep-link-routing.test.ts](file://apps/electron/src/main/__tests__/deep-link-routing.test.ts#L23-L103)
