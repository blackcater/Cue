...
- 事件类型与目标
  ...
  - 事件包括：complete、error、sources_changed、labels_changed、status、info、interrupted、title_*、async_operation、working_directory_changed、permission_mode_changed、session_model_changed、llm_connection_changed、user_message、session_shared/unshared、auth_request/completed 等
- 渲染进程处理
